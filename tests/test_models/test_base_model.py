...
class TestAmenity(unittest.TestCase):
    ...
    def test_name_attr(self):
        """this test Amenity has attribute name, and it's as an empty string"""
        amenity = Amenity()
    ...
    def test_to_dict_creates_dict(self):
        """this will test to_dict method creates a dictionary with proper attrs"""
        am = Amenity()
        print(am.__dict__)
        new_d = am.to_dict()
    ...
    def test_to_dict_values(self):
        """confirms values in dict returned from to_dict are correct"""
