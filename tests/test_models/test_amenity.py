...
class test_inherit_basemodel(unittest.TestCase):
    """This will Test whether user will inherit from BaseModel"""
    def test_instance(self):
        """This will checks if user is instance of BaseModel"""
        user = Amenity()
...
class TestAmenity(unittest.TestCase):
    ...
    def test_to_dict_values(self):
        """This checks  values in dict returned from to_dict are correct"""
    ...
    def test_str(self):
        """confirms str method has the correct output"""
        amenity = Amenity()
